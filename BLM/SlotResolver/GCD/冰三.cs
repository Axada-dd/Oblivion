...
public class 冰三 : ISlotResolver
{
    ...
    public int Check()
    {
        ...
        if (BLMHelper.火状态 && Spells.墨泉.GetSpell().Cooldown.TotalSeconds > 10 && Core.Me.CurrentMp < 800 
            && !BattleData.Instance.可瞬发 && BLMHelper.耀星层数 != 6 && (BattleData.Instance.前一gcd != Spells.冰澈 || BattleData.Instance.前一能力技 != Spells.墨泉)) return 1;
